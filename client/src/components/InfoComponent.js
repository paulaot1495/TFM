...
function InfoComponent(props) {
  ...
  useEffect(() => {
    ...
    <div id="rol">
        ...
        <h2> Para registrar un nuevo lote de vacunas deberás pagar el precio de 10e15 Wei, de los cuales 3 10e14 Wei irán destinados al transportista al completarse el proceso. </h2>
